...
echo "  export AUTH_SERVER_BUILD_CONTEXT=$PARENT_DIR/craftalism-authorization-server/java"
echo "  export API_BUILD_CONTEXT=$PARENT_DIR/craftalism-api/java"
echo "  export DASHBOARD_BUILD_CONTEXT=$PARENT_DIR/craftalism-dashboard/react"
echo "  export AUTH_SERVER_DOCKERFILE=Dockerfile"
